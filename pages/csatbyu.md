...
Overall, getting the degree has been worth it for the job prospects alone, and I learned a lot of interesting stuff too, but as you'll see in this post, my attitude towards my college education is ambivalent at best.
...
The home stretch -- by this point in my education I already had a few full time job offers and I knew what I wanted to do after graduating, so I just took a couple of easy classes and coasted.

Database Modeling Concepts from Bruce Conrad was the easiest class I have ever taken. Dr Conrad is a cute old man, I believe he's pushing 70 years old, and he has had a long career writing code for traditional, waterfall-style software firms. He was never actually a database administrator but he knows a few things. The class started out with SQL, which I knew already from previous jobs, and then moved to NoSQL and graph databases, but he didn't cover them in enough depth that you actually have to learn anything. There was one very small group project that we had to spend a little time on. 5/10.

Computer Communications and Networking from Casey Deccio was actually pretty interesting. We learned about most of the important TCP/IP protocols, including Ethernet, IP, UDP, TCP, ICMP, HTTP, DNS, SMTP, BGP, and more. The labs consisted of implementing a handful of these protocols in a sandbox. Dr Deccio had improved a little as a teacher but still answers way too many questions during class. 7/10.

Ethics and Computers in Society from Darin Gates was one of those classes I just took because it was required. Dr Gates is a good lecturer, and I enjoyed thinking about ethics and philosophy, but I have never felt that teaching philosophy makes very much sense in a classroom setting. There were a few papers and a handful of quizzes. Overall pretty easy class, didn't have to spend too much time on it. 5/10.
